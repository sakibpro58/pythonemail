...
socks.set_default_proxy(socks.SOCKS5, PROXY_HOST, PROXY_PORT, True, PASSWORD, None)
socket.socket = socks.socksocket  # Use SOCKS5 for socket connections

# Test connection to httpbin to see if proxy is working
try:
    ...
    print(f"Error while testing proxy: {e}")
